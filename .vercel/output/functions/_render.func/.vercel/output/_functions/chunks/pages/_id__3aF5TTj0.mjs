...
const $$Image = createComponent(
  ...
  "C:/Users/Aldiyar Nurgazin/astro-test/exotic-ephemera/node_modules/astro/components/Image.astro",
  void 0,
);
...
const $$Picture = createComponent(
  ...
  "C:/Users/Aldiyar Nurgazin/astro-test/exotic-ephemera/node_modules/astro/components/Picture.astro",
  void 0,
);
...
const $$Comment = createComponent(
  ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<li class="comment" data-astro-cid-ksttp56e> <h2 class="comment-author" data-astro-cid-ksttp56e> ${comment.author} </h2> <h3 class="comment-date" data-astro-cid-ksttp56e> ${date.toLocaleString()} </h3> <p class="comment-text" data-astro-cid-ksttp56e> ${comment.text} </p> </li> `;
  },
  "C:/Users/Aldiyar Nurgazin/astro-test/exotic-ephemera/src/components/Comment.astro",
  void 0,
);
...
const $$id = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    const response = await fetch(
      "https://g4me-zone-api.vercel.app/api/article/" + id,
    );
    const data = await response.json();
    const article = data.data;
    const release = new Date(article.release_date);
    const comments = await fetch(
      "https://g4me-zone-api.vercel.app/api/comments/" + id,
    ).then((r) => r.json());
    return renderTemplate`${renderComponent(
      $$result,
      "Layout",
      $$Layout,
      { title: article.title, "data-astro-cid-dpxbdw67": true },
      {
        default: (
          $$result2,
...
Genre: ${article.genre} </p> </div> <div class="article-body" data-astro-cid-dpxbdw67> <p data-astro-cid-dpxbdw67> ${article.text} </p> <p data-astro-cid-dpxbdw67>Review Written By: ${article.author}</p> </div> <ul role="list" class="article-comment-grid" data-astro-cid-dpxbdw67> ${comments.data.length > 0 ? comments.data.map((comment) => renderTemplate`${renderComponent($$result2, "Comment", $$Comment, { comment: comment, "data-astro-cid-dpxbdw67": true })}`) : renderTemplate`<li data-astro-cid-dpxbdw67>No comments Yet</li>`} </ul> </main> `,
      },
    )} `;
  },
